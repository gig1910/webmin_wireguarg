...
### Управление, диагностика и экспорт клиентской конфигурации

[![Управление интерфейсом и пирами, диагностика, журналы и экспорт клиентской конфигурации](docs/images/interface-details.webp)](docs/images/interface-details.webp)

На объединённом изображении показаны управление интерфейсом и пирами, графики
трафика, ping и traceroute, журнал интерфейса, сформированная клиентская
конфигурация и экспорт через QR-код.
